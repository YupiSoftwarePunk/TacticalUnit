...
export default function PostPage({params}: {params: Promise<{subdivisionId: string}>}) {
    ...
    return (<RRForm title="Подразделение">
            ...
            <AccordingUnitsTable TableName="Бойцы состоящие в этом подразделении" rightsToGrant={canGrant} GIVEN_COLUMNS_LAYOUT={COLUMNS_CONFIG} GIVEN_DATA={MEMBERS_DATA}></AccordingUnitsTable>
        </RRForm>
        )
